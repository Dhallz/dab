...
import 'dashboard_follow_search_menu.dart';

/// [ARCH: PRESENTATION_WIDGET]
/// ROLE: Focused autocomplete at the top of Following for any matching
/// Phorge/Jira/Linear issue plus git branches that are not already in the
/// live inbox. Suggestions appear in an
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return OverlayPortal.targetsRootOverlay(
          controller: _overlay,
          overlayChildBuilder: (context) => DashboardFollowSearchMenu(
            link: _link,
            tapGroup: _tapGroup,
            width: width,
            state: widget.state,
