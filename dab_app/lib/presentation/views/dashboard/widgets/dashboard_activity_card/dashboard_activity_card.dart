...
import '../../../../core/extensions/activity_provider_extensions.dart';
import '../../../../core/extensions/string_extensions.dart';
import '../../../../core/localization/app_localizations.dart';
import '../../../../core/localization/l10n_extension.dart';
import '../../../../core/styles/app_icons.dart';
import '../../../../core/styles/app_spacing.dart';
import '../../../../core/widgets/activity_provider_icon.dart';
import '../../../../core/widgets/dab_glass_surface.dart';
import 'dashboard_archived_badge.dart';
...
class _DashboardActivityCardState extends State<DashboardActivityCard> {
  ...
  Widget build(BuildContext context) {
    ...
    final headline = widget.activity.dashboardHeadline;
    final branch = widget.activity.provider.gitBranchLabel;
    final showSenderLine =
        widget.activity.authorName.trim().isNotEmpty &&
        !widget.activity.authorName.looksLikeOpaqueUserId &&
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  Text(
                                    widget.activity.isDashboardWatchingPlaceholder
  ...
  bool get _canFollow =>
      widget.activity.provider.followObjectKey != null &&
