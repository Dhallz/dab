...
class ProviderSectionResultMapper
  ...
  static ViewStatus _$status(ProviderSectionResult v) => v.status;
  static const Field<ProviderSectionResult, ViewStatus> _f$status = Field(
    'status',
    _$status,
  );
...
>
  ...
  $R call({ViewStatus? status, String? message});
...
class _ProviderSectionResultCopyWithImpl<$R, $Out>
  ...
  @override
  $R call({ViewStatus? status, String? message}) => $apply(
    FieldCopyWithData({
...
class ProviderConnectivityReportMapper
  ...
  static ViewStatus _$aggregate(ProviderConnectivityReport v) => v.aggregate;
  static const Field<ProviderConnectivityReport, ViewStatus> _f$aggregate =
      Field('aggregate', _$aggregate);
