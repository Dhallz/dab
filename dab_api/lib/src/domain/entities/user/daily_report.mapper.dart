...
class DailyReportMapper extends ClassMapperBase<DailyReport> {
  ...
  static String _$id(DailyReport v) => v.id;
  static const Field<DailyReport, String> _f$id = Field('id', _$id);
  static String _$userId(DailyReport v) => v.userId;
  static const Field<DailyReport, String> _f$userId = Field('userId', _$userId);
  ...
  static DateTime? _$updatedAt(DailyReport v) => v.updatedAt;
  static const Field<DailyReport, DateTime> _f$updatedAt = Field(
    'updatedAt',
    _$updatedAt,
    opt: true,
  );
