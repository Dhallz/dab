...
/// CONTRACT: [subjectKey] is unique per report (provider + object + occurrence).
/// [note] is DAB-only; never posted to providers. Snapshot fields restore the
/// line if the live/search pool no longer contains the occurrence.
@MappableClass()
