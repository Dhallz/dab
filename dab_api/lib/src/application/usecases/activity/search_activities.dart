...
/// provider APIs via [UnifiedActivityFetcher] and unions screenshot seed rows.
/// **Does not** query PostgreSQL; ingested rows on disk are surfaced elsewhere
/// (`GET /activities`, live Redis fan-out).
