...
void main() {
  ...
  test('persists a Follow-lane copy for a branch pin without Settings watches', () async {
    final author = User(
      id: 'u-gh',
      name: 'Ada',
      email: 'ada@example.com',
    ...
    final followerUseCase = IngestGitHubWebhook(
      userRepository,
      activityRepository,
      providerConfigRepository,
      redisService,
      presenceService,
      credentials: FakeCredentialResolver(const {
        'u-gh': {'watchedRepos': <String>[]},
        'u-bob': {'watchedRepos': <String>[]},
      }),
      follows: follows,
    );
    ...
    final out = await followerUseCase.execute(
      payload: <String, dynamic>{
        'repository': {'full_name': 'Acme/app'},
